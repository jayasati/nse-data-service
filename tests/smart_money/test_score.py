...
def test_run_pass_persists_score():
    ...
    conn.executescript(
        ...
        "fut_idx_short INT, opt_idx_call_long INT, opt_idx_put_long INT, opt_idx_call_short INT, "
    ...
    conn.execute("INSERT INTO raw_participant_oi VALUES ('FII','2026-05-27',100,50,200,100,50,150)")
    conn.commit()
    ...
    assert row[0] is not None and row[1] > 0.6            # FII long-heavy = bullish derivatives
