...
def latest(conn=Depends(_get_conn)) -> JSONResponse:
    ...
    rows = conn.execute(
        ...
        "conviction_band, open_iep, gap_pct, conviction_adj, conf_label, conf_agreement, conf_confirm, "
    ...
    cols = ["symbol", "composite", "tier", "catalyst", "positioning", "options", "structure",
            ...
            "t1", "t2", "t3", "rr", "setup", "conviction_band", "open_iep", "gap_pct", "conviction_adj",
